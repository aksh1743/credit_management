...
<style>
  ...
  background-size: cover;
    ...
    <div class="" style="width:40%;margin-left:30%">
        ...
        <header class="">
            <h2 class="text-warning text-center " style="color: orange; text-align:center " > Processing </h2>
        </header>
        <form method="post" name="tcredit" style="margin-left:10%;margin-right:10%;border:solid 2px white;border-radius: 25px 25px 25px 25px;"><br/>
            <?php
                include 'connection.php';
                $sid=$_GET['id'];
            ...
            ?>
                ...
                <?php echo $res['UserName'] ;?>
                  <span style="color: yellow;">  <?php echo $res['Email'] ;?></span>
